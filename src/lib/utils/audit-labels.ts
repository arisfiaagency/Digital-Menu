...
const FIELD_LABELS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    posKitchenLabel: "kitchen button name",
    posBarLabel: "bar button name",
  ...
  ar: {
    ...
    posKitchenLabel: "اسم زر المطبخ",
    posBarLabel: "اسم زر البار",
    openHour: "ساعة الفتح",
  ...
  ckb: {
    ...
    posKitchenLabel: "ناوی دوگمەی چێشتخانە",
    posBarLabel: "ناوی دوگمەی بار",
